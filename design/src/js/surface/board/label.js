/* ------------------------------------------------------------------
   ...
   move -- and its axes are not equally sturdy (the measurement: ff-jarvis model/season/ARCHETYPE.md,
   "`style` — four, career, and the axes are not equally sturdy"). That is a data point a reader folds into a
...
/* Why a flag is a pill beside the word and never a fourth value: ff-jarvis
   model/season/ARCHETYPE.md, "Quarterback" (the goal_line_runner paragraph). */
